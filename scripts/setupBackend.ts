...
const INITIAL_TRADERS = [
    {
        ...
        bio: 'Anas Ali is a fast-growing forex and crypto trader known for high-accuracy Risk Free trade signals and bold market execution.',
        category: 'crypto',
    ...
    },
    {
        ...
        bio: 'Rayner Teo is an independent trader and founder of TradingwithRayner, known for clear, profit-first content.',
        category: 'crypto',
    ...
    },
    {
        ...
        bio: 'Thomas Kralow is a high-performance crypto and forex trader known for AI-driven trading strategies.',
        category: 'crypto',
    ...
    },
    {
        ...
        bio: 'P4 Provider is a professional Forex and Crypto trader with over 8 years of experience.',
        category: 'crypto',
    ...
    },
    {
        ...
        bio: 'A high-speed binary options specialist focusing on short-term market momentum.',
        category: 'binary',
    ...
    },
    {
        ...
        bio: 'Elite binary analyst delivering high-frequency signals based on volatility patterns.',
        category: 'binary',
    ...
    },
    {
        ...
        bio: 'A high-level gold market analyst specializing in precision price action.',
        category: 'gold',
    ...
    },
    {
        ...
        bio: 'Trader Nick is a high-performance crypto and forex trader known for aggressive yet controlled market execution.',
        category: 'forex',
    ...
    },
    {
        ...
        bio: 'Elite crypto and forex trader delivering explosive market insights with precision execution.',
        category: 'forex',
...
const setupBackend = async () => {
    ...
    try {
        ...
        if (tradersSnapshot.empty) {
            console.log('   No traders found. Starting migration...');
            ...
            await batch.commit();
            console.log(`   ✅ ${INITIAL_TRADERS.length} traders migrated successfully!`);
        } else {
            console.log(`   ✅ Traders already exist (${tradersSnapshot.size} found)`);
        }
