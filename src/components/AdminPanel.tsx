...
const AdminPanel: React.FC = () => {
    ...
    // State
    const [activeTab, setActiveTab] = useState<'traders' | 'strategies' | 'factory'>('traders');
        ...
        <div className="min-h-screen bg-[#131722] p-4 md:p-8 pb-32">
            <div className="max-w-7xl mx-auto space-y-8">
                ...
                <div className="flex bg-[#1e222d] p-1 rounded-xl border border-white/5">
                    ...
                    <button onClick={() => setActiveTab('factory')} className={`px-4 md:px-6 py-2 rounded-lg text-xs font-black uppercase tracking-wider transition-all ${activeTab === 'factory' ? 'bg-[#f01a64] text-white shadow-lg' : 'text-gray-500 hover:text-white'}`}>Factory</button>
                </div>
                ...
                <div className="bg-[#1e222d] rounded-[2.5rem] border border-white/5 p-6 md:p-8 min-h-[500px]">
                    <div className="flex justify-between items-center mb-8">
                        <h2 className="text-xl font-black text-white uppercase italic">
                            {activeTab === 'traders' ? 'Active Traders Database' : activeTab === 'strategies' ? 'Profit Strategy Logic' : 'Trader Factory'}
                        </h2>
                        {activeTab !== 'factory' && (
